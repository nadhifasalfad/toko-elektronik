...
<head>
    ...
    <style>
        body {background-color: #1A3D64; height: 100vh; display: flex; align-items: center; justify-content: center;}
        .card { width: 400px; border-radius: 1rem; overflow: hidden; border:none; }
        .btn-primary { background-color: #1A3D64; border-radius: 10rem; }
    </style>
</head>
<body>
